...
export const BCP47_TO_SLUG: Readonly<Record<string, string>> = Object.fromEntries(
  LOCALE_REGISTRY.map((entry) => [entry.bcp47, entry.slug]),
);

export const SLUG_TO_BCP47: Readonly<Record<string, string>> = Object.fromEntries(
